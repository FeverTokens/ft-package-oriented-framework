...
interface IAccessAuthorization is IAccessAuthorizationInternal {
    /**
     ...
     */
    function addAuthorization(bytes4 functionSig, bytes32 role) external;
     ...
     */
    function removeAuthorization(bytes4 functionSig, bytes32 role) external;
