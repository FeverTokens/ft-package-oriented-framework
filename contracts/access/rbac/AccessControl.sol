...
abstract contract AccessControl is IAccessControl, AccessControlInternal {
     ...
     * @inheritdoc IAccessControl
     */
    function getRoleMember(bytes32 role, uint256 index) external view virtual returns (address) {
     ...
     * @inheritdoc IAccessControl
     */
    function getRoleMemberCount(bytes32 role) external view virtual returns (uint256) {
